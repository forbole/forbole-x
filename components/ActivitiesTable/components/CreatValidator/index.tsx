...
const CreatValidator: React.FC<ActivitiesTableProps> = ({ activity, account }) => {
...
//   console.log('activities', activities)
  ...
  return (
    <Box display="flex" alignItems="center">
      ...
      {activity.tag}d
      <span className={classes.amount}>{formatCrypto(activity.delegatedAmount, 'ATOM', 'en')}</span>
      {activity.tag === 'delegate' ? '' : 'from'}
      <Avatar
